...
.add_filter("subscriptiontrack", "enable", 1)
.add_filter("subscriptiontrack", "text/plain", "配信停止をご希望の場合リンクをクリックしてください: <% %>.")
.add_filter("subscriptiontrack", "text/html", " 配信停止をご希望の場合<% リンク %>をクリックしてください")
